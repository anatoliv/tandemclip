...
enum HelpCatalog {
    ...
    static let topics: [HelpTopic] = [
        ...
        .init(id: "sync-max-size", category: "Settings — Sync", title: "Max clipboard size",
              body: "The biggest clip that will sync (default 5 MB). Anything larger falls back to just its plain text, or is skipped if there's no text. Raise it if you often copy large images or files between Macs."),
